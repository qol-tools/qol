...
impl GlobalHotKeyManager {
    ...
    /// Releases an active X11 keyboard grab without removing any registered
    /// passive hotkeys. This lets a window manager take ownership of an
    /// operation started by a held global hotkey.
    #[cfg(any(
        target_os = "linux",
        target_os = "dragonfly",
        target_os = "freebsd",
    ...
    pub fn release_active_grab(&self) -> crate::Result<()> {
        self.platform_impl.release_active_grab()
    }
}
