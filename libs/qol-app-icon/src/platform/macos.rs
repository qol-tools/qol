...
fn process_start_time_us(pid: i32) -> Option<u64> {
...
fn icon_for_bundle_id(bundle_id: &str, size: usize) -> Option<RgbaImage> {
...
fn icon_for_pid(pid: i32, size: usize) -> Option<RgbaImage> {
