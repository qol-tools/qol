...
pub use fallback::{
    ...
    park_window_by_title, prepare_window_reveal_by_title, reposition_window_by_title,
...
pub use linux::{
    ...
    park_window_by_title, prepare_window_reveal_by_title, release_focus_by_title,
