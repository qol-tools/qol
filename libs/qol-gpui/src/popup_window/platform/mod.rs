...
pub use fallback::{
    ...
    hide_invisible, hide_window_by_title, hide_windows_by_title_prefix, park_window_by_title,
...
pub use linux::{
    configure_keepalive_window, configure_overlay_window, configure_pinned_window,
    configure_popup_window, disable_window_shadow, dump_ghost_windows, focus_window_by_title,
    force_composite_below, hide_for_capture, hide_invisible, hide_window_by_title,
    hide_windows_by_title_prefix, make_override_redirect, park_window_by_title,
    prepare_window_reveal_by_title, release_focus_by_title, reposition_window_by_title,
    restore_composite, set_ghost_debug, show_window_by_title, show_window_passive_by_title,
