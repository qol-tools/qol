...
use crate::picker::layout::*;
use crate::picker::run::SharedPreviewCache;
use crate::picker::{IconMap, PickerWindowState, PreviewMap, SharedIconCache};
...
impl PickerInit {
    fn new(
        ...
        Self {
            ...
            card_color,
            card_opacity,
            unselected_card_opacity: config.display.unselected_card_opacity,
