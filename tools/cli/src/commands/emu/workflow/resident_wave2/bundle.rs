...
const PRODUCT_CLOSURE_ROOTS: [&str; 2] = ["libs", "apps/tray"];
...
mod tests {
    ...
    fn sample_entries() -> Vec<ProductEntry> {
        vec![
            ...
            ProductEntry {
                path: "apps/tray/Cargo.toml".to_string(),
                mode: 0o644,
                sha256: "b".repeat(64),
            },
        ]
    ...
    fn product_key_is_deterministic_and_input_sensitive() {
        ...
        changed_path[1].path = "apps/tray/src/lib.rs".to_string();
    ...
    fn scenario_edits_stay_outside_the_product_closure_and_key() {
        ...
        fs::create_dir_all(root.join("apps/tray/src")).unwrap();
        ...
        fs::write(root.join("apps/tray/src/lib.rs"), b"tray source").unwrap();
        let facts = sample_facts();
    ...
    fn product_closure_entries_are_relative_sorted_and_hashed() {
        ...
        let entries = vec![
            ...
            ProductEntry {
                path: "apps/tray/src/lib.rs".to_string(),
                mode,
