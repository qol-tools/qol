...
- CLI source: `tools/cli`
- Command list: `tools/cli/src/cli.rs`
- Dispatch: `tools/cli/src/main.rs`
- Dev dashboard: `tools/cli/src/dev_console.rs`
- Emu discovery/runtime: `tools/cli/src/commands/emu.rs`
