...
mod tests {
    ...
    fn recompile_root_stays_on_default_workspace_when_binary_was_built_from_a_worktree() {
        ...
        write_qol_tray_package(&base.join("apps").join("tray"));
        write_qol_tray_package(&worktree.join("apps").join("tray"));
