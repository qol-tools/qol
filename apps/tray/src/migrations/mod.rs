...
static PRE_FLIGHT_FAILED: AtomicBool = AtomicBool::new(false);

pub fn note_pre_flight_failure() {
    PRE_FLIGHT_FAILED.store(true, Ordering::SeqCst);
}

pub fn pre_flight_failed() -> bool {
    PRE_FLIGHT_FAILED.load(Ordering::SeqCst)
}
