...
mod tests {
    ...
    fn release_url_uses_per_plugin_tag_against_source_repo_not_dep_repo() {
        let cases: &[(&str, ReleaseTagPick, &str)] = &[
            ...
            (
                "qol-tools/qol",
                ReleaseTagPick::PluginTag("qol-alt-tab-v1.2.3".to_string()),
                "https://api.github.com/repos/qol-tools/qol/releases/tags/qol-alt-tab-v1.2.3",
            ),
            (
                "qol-tools/qol",
                ReleaseTagPick::PluginTag("qol-launcher-v0.4.0".to_string()),
                "https://api.github.com/repos/qol-tools/qol/releases/tags/qol-launcher-v0.4.0",
            ),
        ];
