...
mod tests {
    ...
    fn rejection_warns_without_fix() {
        let report = report_for(GuardStatus::Rejected(
            "apps/tray/src/plugins/daemon_health.rs:167:99999".to_string(),
        ));
        ...
        assert!(
            report
                .summary
                .contains("apps/tray/src/plugins/daemon_health.rs:167"),
            "summary: {}",
            report.summary
        );
    }
  ...
  offending occurrences:
    apps/tray/src/plugins/daemon_health.rs:167:99999
