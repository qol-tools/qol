...
**Worktree:** `/media/kmrh47/WD_SN850X/Git/qol-tools/qol-tray/.worktrees/hide-cpu-button`
...
```bash
cd /media/kmrh47/WD_SN850X/Git/qol-tools/qol-tray/.worktrees/hide-cpu-button
