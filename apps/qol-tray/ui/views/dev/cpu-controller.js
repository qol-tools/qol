...
function pruneSamples(state, mergedList, persist, queueSync) {
...
export function createCpuController({ state, getVisiblePluginIds, onNeedsRender }) {
    ...
    return {
        ...
        hydrate,
        prune: list => pruneSamples(state, list, persist, doSync),
        queueSync: doSync,
